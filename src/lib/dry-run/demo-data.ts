...
export const dryRunEvents: DryRunEvent[] = [
  ...
  { type: "status", at: 200, stage: "Navigation", message: "Opening salonagent.ai and mapping the page structure." },
  { type: "website_focus", at: 400, sectionId: "navigation", scrollTo: 0 },
  { type: "status", at: 1600, stage: "Hero", message: "Reading the primary promise and buyer pain." },
  { type: "website_focus", at: 1800, sectionId: "hero", scrollTo: 8 },
  { type: "schema_answer", at: 2400, sectionId: "summary" },
  { type: "schema_answer", at: 3800, sectionId: "customer" },
  { type: "website_focus", at: 4600, sectionId: "how-it-works", scrollTo: 28 },
  { type: "status", at: 4800, stage: "How it works", message: "Extracting the workflow behind missed-call recovery." },
  { type: "schema_answer", at: 5600, sectionId: "pain" },
  { type: "schema_answer", at: 7000, sectionId: "differentiators" },
  { type: "website_focus", at: 7800, sectionId: "social-proof", scrollTo: 48 },
  { type: "status", at: 8000, stage: "Social proof", message: "Looking for proof points and operator language." },
  { type: "schema_answer", at: 9000, sectionId: "competitors" },
  { type: "website_focus", at: 10000, sectionId: "stats", scrollTo: 68 },
  { type: "schema_answer", at: 10600, sectionId: "search" },
  { type: "schema_answer", at: 11800, sectionId: "communities" },
  { type: "website_focus", at: 12600, sectionId: "footer", scrollTo: 86 },
  { type: "schema_answer", at: 13200, sectionId: "tone" },
  { type: "schema_answer", at: 14200, sectionId: "avoid" },
  { type: "phase", at: 15600, phase: "discovery" },
  { type: "status", at: 15800, stage: "Search angles", message: "Turning the profile into platform-native searches." },
  { type: "source_search", at: 16600, source: "reddit", query: "salon missed calls receptionist alternative" },
  { type: "source_search", at: 17600, source: "x", query: "AI receptionist local business salon" },
  { type: "opportunity", at: 18600, cardId: "reddit-missed-calls" },
  { type: "source_search", at: 19600, source: "hacker_news", query: "AI agents local businesses missed revenue" },
  { type: "opportunity", at: 20800, cardId: "x-ai-receptionist" },
  { type: "source_search", at: 21800, source: "github", query: "booking SMS missed call issue" },
  { type: "opportunity", at: 23200, cardId: "hn-local-ai" },
